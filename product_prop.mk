...
PRODUCT_PROPERTY_OVERRIDES += \
    ...
    persist.log.tag.SSDecisonMaker=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.GsmMmiCode=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.RpSsController=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.RIL-SS=$(VENDOR_LOG_LEVEL) \
    ...
    persist.log.tag.DC-1=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.DC-2=$(VENDOR_LOG_LEVEL) \
    ...
    persist.log.tag.GbaApp=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.GbaBsfProcedure=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.GbaBsfResponse=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.GbaDebugParam=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.GbaService=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.SresResponse=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.ImsUtService=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.SimservType=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.SimservsTest=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.ImsUt=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.SuppSrvConfig=$(VENDOR_LOG_LEVEL) \
    ...
    persist.log.tag.SuppServHelper=$(VENDOR_LOG_LEVEL) \
